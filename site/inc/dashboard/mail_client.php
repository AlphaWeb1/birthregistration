                                    ...
                                    <section class="row justify-content-center">
                                        <div class="col-md-7 card">
                                            <h4 class="card-heading bg-warning mt-2 text-center">
                                                <img class="img float-left" style="max-width: 100px;" src="'.$Site['siteProtocol'].''.$Site['domainName'].'/site/media/i/scog-logo.jpg" alt="'.$Site['companyName'].'"> <h2 class="trans-title text-center">'.$Site['companyName'].' | '.$itemName.' Enrolment Receipt</h2>
                                            </h4>
                                            <div class="card-body row justify-content-center text-none">

                                                <div class="col-sm-6 float-left">
                                                    <h5 class="font-weight-bold">Package Detail</h5>
                                                    <h6>Program Title:  '.$programDetails->title.'</h6>
                                                    <h6>Program Type: '.$payment->programtype.'</h6>
                                                ...
                                                <div class="col-sm-12 mt-2">
                                                    ...
                                                    <h4><a href="'.$Site['siteProtocol'].''.$Site['domainName'].'/root/receipt?rec='.$stripeResponse->balance_transaction.'" target="__blank">Click Me</a></h4>
                                                </div>
                                            </div>
